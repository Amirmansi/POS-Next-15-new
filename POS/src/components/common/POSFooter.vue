...
const linkText = ref('Eng Amir Ahmed Mansi')
...
const loadBrandingConfig = async () => {
	try {
		...
		linkText.value = 'Eng Amir Ahmed Mansi'
		footerLink.value = '#'
	}
}
...
const ensureBranding = () => {
	...
	const expectedBrand = atob(config.value._l || btoa('Eng Amir Ahmed Mansi'))
	const expectedUrl = atob(config.value._u || btoa('#'))
