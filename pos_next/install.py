...
def create_installment_custom_fields(quiet=False):
	...
	fields = [
		...
		{
			"dt": "Sales Invoice",
			"fieldname": "custom_is_installment_sale",
			"fieldtype": "Check",
			"label": "بيع بالتقسيط",
			"insert_after": "custom_customer_whatsapp",
			"default": "0",
			"read_only": 1,
		},
		{
			"dt": "Sales Invoice",
			"fieldname": "custom_installment_months",
			"fieldtype": "Int",
			"label": "عدد الأشهر",
			"insert_after": "custom_is_installment_sale",
			"read_only": 1,
			"depends_on": "eval:doc.custom_is_installment_sale",
		},
		{
			"dt": "Sales Invoice",
			"fieldname": "custom_installment_interest_rate",
			"fieldtype": "Percent",
			"label": "نسبة الفائدة %",
			"insert_after": "custom_installment_months",
			"read_only": 1,
			"depends_on": "eval:doc.custom_is_installment_sale",
		},
		{
			"dt": "Sales Invoice",
			"fieldname": "custom_installment_down_payment",
			"fieldtype": "Currency",
			"label": "الدفعة المقدمة",
			"insert_after": "custom_installment_interest_rate",
			"read_only": 1,
			"depends_on": "eval:doc.custom_is_installment_sale",
		},
		{
			"dt": "Sales Invoice",
			"fieldname": "custom_installment_first_date",
			"fieldtype": "Date",
			"label": "تاريخ أول قسط",
			"insert_after": "custom_installment_down_payment",
			"read_only": 1,
			"depends_on": "eval:doc.custom_is_installment_sale",
		},
		{
			"dt": "Sales Invoice",
			"fieldname": "custom_installment_total_interest",
			"fieldtype": "Currency",
			"label": "إجمالي الفائدة",
			"insert_after": "custom_installment_first_date",
			"read_only": 1,
			"depends_on": "eval:doc.custom_is_installment_sale",
		},
		{
			"dt": "Sales Invoice",
			"fieldname": "custom_installment_total_contract",
			"fieldtype": "Currency",
			"label": "إجمالي التعاقد",
			"insert_after": "custom_installment_total_interest",
			"read_only": 1,
			"depends_on": "eval:doc.custom_is_installment_sale",
		},
		{
			"dt": "Sales Invoice",
			"fieldname": "custom_installment_monthly_amount",
			"fieldtype": "Currency",
			"label": "القسط الشهري",
			"insert_after": "custom_installment_total_contract",
			"read_only": 1,
			"depends_on": "eval:doc.custom_is_installment_sale",
		},
		{
			"dt": "Sales Invoice",
			"fieldname": "custom_installment_schedule",
			"fieldtype": "Table",
			"label": "جدول الأقساط",
			"options": "Installment Schedule",
			"insert_after": "custom_installment_monthly_amount",
			"depends_on": "eval:doc.custom_is_installment_sale",
		},
	]
